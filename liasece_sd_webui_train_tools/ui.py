            ...
            with gr.Box():
                with gr.Row():
                    ...
                    with gr.Column():
                        ...
                        train_scheduler = gr.Dropdown(choices=["linear", "cosine", "cosine_with_restarts"], value="cosine", label="lr_scheduler", multiselect = True, elem_id="train_scheduler", interactive=True)
