            ...
            with gr.Box():
                with gr.Row():
                    ...
                    with gr.Column():
                        ...
                        train_scheduler = gr.Dropdown(["linear", "cosine", "cosine_with_restarts"], value="cosine", label="lr_scheduler", elem_id="train_scheduler", interactive=True)
                        train_cosine_restarts = gr.Textbox(value=None, label="the number of times lr restarts", placeholder="(Optional)For Cosine with restart only", elem_id="train_cosine_restarts", lines=1, max_lines=1, interactive=True)
